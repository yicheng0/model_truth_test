    ...
    const fetchMock = vi.spyOn(globalThis, 'fetch').mockResolvedValueOnce(
      new Response(
        JSON.stringify({
          ...
          confidence: { level: 'low', score: 5, sample_count: 2, independent_run_count: 1, module_coverage: 0.25, freshness_hours: 1, reasons: ['sample_count_low'] },
          dimensions: {
            availability: { score: 100, status: 'healthy', reasons: [], details: {} },
            performance: { score: 90, status: 'healthy', reasons: [], details: { p95_latency_ms: 180 } },
            protocol: { score: 100, status: 'healthy', reasons: [], details: {} },
            quality: { score: 88, status: 'watch', reasons: [], details: {} },
          },
          reference_band: { status: 'baseline_inconclusive' },
          status_reasons: [],
